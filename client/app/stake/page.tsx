    ...
    <div className="min-h-screen bg-background ancient-texture">
      ...
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/stake" className="text-accent font-medium">
              Stake
            </Link>
      ...
      <div className="pt-24 pb-12 px-4">
        <div className="container mx-auto">
          <ScrollReveal>
            <h1 className="text-4xl md:text-6xl font-heading font-bold text-center mb-8 text-foreground">
              Your <span className="text-accent">Stakes</span>
            </h1>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <Card className="sketch-border ancient-texture border-border bg-card/50 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-muted-foreground">Active Adventures</div>
                </CardContent>
              </Card>
